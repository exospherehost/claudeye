...
[![license](https://img.shields.io/npm/l/claudeye)](./LICENSE)
[![node](https://img.shields.io/node/v/claudeye)](https://nodejs.org)
[![GitHub stars](https://img.shields.io/github/stars/exospherehost/claudeye)](https://github.com/exospherehost/claudeye)
...
<!-- Record a 15-30s GIF using VHS (https://github.com/charmbracelet/vhs):
     npm i -g claudeye && claudeye → browser opens → navigate session → expand subagent → see evals -->
<p align="center">
  <img src="https://github.com/exospherehost/claudeye/raw/main/docs/demo.gif" alt="Claudeye demo" width="720" />
  <br />
  <em>One command. Full visibility into every Claude agent session.</em>
</p>
...
- [GitHub Discussions](https://github.com/exospherehost/claudeye/discussions) — ask questions, share ideas, show your evals
<!-- TODO: Set up Discord server and uncomment the line below -->
<!-- - [Discord](https://discord.gg/YOUR_INVITE) — real-time chat with the team and other users -->
